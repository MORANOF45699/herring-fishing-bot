...
# อ่านน้ำหนักท้ายรถมุมขวาล่างของฝั่ง SECONDARY เช่น "350.00/800.00"
# เต็มเมื่อ "เลขซ้าย = เลขขวา" → ตัดที่ตัว "/" แล้วเทียบพิกเซลสองฝั่ง
# ตัวเลขเดียวกันเกมวาดเหมือนกันเป๊ะ → ต่างกัน 0% = เต็ม
# ใช้ได้กับรถทุกความจุ (200/300/400/500/600/700/800 ...) ไม่ต้องตั้งค่าเพิ่ม
# อ้างอิง 1920x1080: left=1735 top=818 w=95 h=26
TRUNK_WEIGHT_REGION = _region(1735 / 1920, 818 / 1080, 95 / 1920, 26 / 1080)
TRUNK_FULL_MAX_DIFF = 0.001   # พิกเซลต่างกันได้ไม่เกินกี่ส่วน ถึงถือว่าเต็ม
                              # เต็มจริงวัดได้ 0.0000 พอดี, เคสไม่เต็มที่ใกล้สุดวัดได้ 0.0027
